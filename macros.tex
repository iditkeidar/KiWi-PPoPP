...
\algnewcommand{\LineComment}[1]{{\color{commentcolor}\Statex \ \  \(\triangleright\) \textit{#1}}}

%\let\oldcomment\Comment
%\renewcommand{\Comment}[1]{\color{commentcolor}\oldcomment{#1}\color{normalcolor}}
\renewcommand{\Comment}[1]{\color{commentcolor}{\hfill\(\triangleright\)\textit{#1}}\color{normalcolor}}
