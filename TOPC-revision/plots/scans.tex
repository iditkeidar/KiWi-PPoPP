...
\begin{axis}[
	mystyle16,
	unbalanced,
	title= {\small{(a) Scan 32K keys, dataset 1M}},
...
\begin{axis}[
	rangestyle_ext,
	title={\small{ (b) Scan 16 threads, dataset 1M}},
...
\begin{axis}[
	rangestyle_ext,
	title={\small{ (c) Scan 16 threads, dataset 10M}},
	xlabel= {Scan range (keys)\\}
]
\addplot [black,mark=square*] table [x={ranges}, y={KiWi}]
...
\begin{axis}[
	...
	title={\small{(d) Put scalability, dataset 1M}}
]
\addplot [black,mark=square*] table [x={threads}, y={KiWi}]
...
\begin{axis}[
	rangestyle_ext,
	xlabel= {Scan range (keys)\\},
	title= {\small{(e) Put 16 threads, dataset 1M}}
]
\addplot [black,mark=square*] table [x={ranges}, y={KiWi}]
...
\begin{axis}[
	rangestyle_ext,
	xlabel= {Scan range (keys)\\},
	title= {\small{(f) Put 16 threads, dataset 10M}}
]
\addplot [black,mark=square*] table [x={ranges}, y={KiWi}]
