...
and massive atomic scans triggered by range queries.
...
We present {\kiwi}, the first atomic KV-map to efficiently support simultaneous massive data retrieval and real-time access.
