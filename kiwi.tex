...
\authorinfo{{Dmitry Basin\\}\and {Edward Bortnikov\\}\and Anastasia Braginsky\and {Eshcar Hillel\\}\and Idit Keidar}{Yahoo Research, Israel}{\{dbasin,ebortnik,anastas,eshcar,idish\}\\@yahoo-inc.com}
\authorinfo{Moshe Sulamy}{Tel-Aviv University}{moshe.sulamy@cs.tau.ac.il}
\authorinfo{Guy Golan Gueta}{VMWare Research, Israel}{ggolangueta@vmware.com}
...
We demonstrated significant performance gains over state-of-the-art %KV-map
implementations that support atomic scans. 

\inote{
Future work could apply {\kiwi} as the in-memory part of a NoSQL store, e.g., HBase~\cite{ApacheHBase}.
