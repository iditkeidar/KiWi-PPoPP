...
\begin{axis}[
	mystyle16,
	unbalanced,
	title= {\small{(a) Scan (32K keys) with background put }},
...
\begin{axis}[
	rangestyle,
	title={\small{ (b) Scan (16 threads) with background put}},
...
\begin{axis}[
	...
	title={\small{(c) Put with background scan (32K keys)}}
]
\addplot [black,mark=square*] table [x={threads}, y={KiWi}]
...
\begin{axis}[
	rangestyle,
	xlabel= {Scan range (keys)\\},
	title= {\small{(d) Put (16 threads) with background scan}}
]
\addplot [black,mark=square*] table [x={ranges}, y={KiWi}]
